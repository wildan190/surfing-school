...
<!-- Hero Section -->
<section class="relative w-full h-[85vh] flex items-center justify-center bg-cover bg-center" 
    ...
    <div class="relative z-10 text-center text-white px-6">
        ...
        <a href="#contact" class="mt-6 inline-block bg-blue-500 px-8 py-3 rounded-full text-white text-lg shadow-lg hover:bg-blue-600 transition duration-300">
            Daftar Sekarang
        </a>
    </div>
</section>
    ...
    <div class="container mx-auto px-6 flex flex-col md:flex-row items-center">
        ...
        <div class="md:w-1/2 text-center md:text-left">
            ...
            <p class="mt-4 text-gray-600 dark:text-gray-300">
                Kami adalah lembaga pendidikan yang berkomitmen untuk memberikan pengalaman belajar terbaik bagi Anda. Dengan kurikulum yang berkualitas, instruktur profesional, dan fasilitas modern, kami siap membantu Anda mencapai kesuksesan.
            </p>
            <ul class="mt-4 space-y-3 text-gray-600 dark:text-gray-300">
                <li>
                    <i class="fas fa-check-circle text-green-500"></i> Pengalaman lebih dari 10 tahun di bidang pendidikan.
                </li>
                <li>
                    <i class="fas fa-check-circle text-green-500"></i> Ribuan alumni telah sukses di berbagai bidang.
                </li>
                <li>
                    <i class="fas fa-check-circle text-green-500"></i> Program pembelajaran fleksibel dan inovatif.
                </li>
            </ul>
            <a href="#contact" class="mt-6 inline-block bg-blue-500 text-white px-6 py-3 rounded-lg shadow-md hover:bg-blue-600 transition">
        ...
        <div class="md:w-1/2 mt-8 md:mt-0">
            <img src="{{ asset('assets/img/about.jpg') }}" alt="Tentang Kami" class="rounded-lg shadow-lg w-full max-w-md mx-auto md:max-w-full">
        </div>
    </div>
</section>
...
<section class="py-16 bg-gray-100 dark:bg-gray-900">
    <div class="container mx-auto px-6">
        ...
        <p class="text-center text-gray-600 dark:text-gray-300 mt-2">Mengapa memilih kami? Berikut adalah keunggulan yang kami tawarkan.</p>

        <div class="grid md:grid-cols-3 gap-8 mt-12">
            <!-- Kurikulum Berkualitas -->
            <div class="p-8 bg-white dark:bg-gray-800 rounded-lg shadow-lg text-center transform hover:scale-105 transition duration-300">
                <div class="text-blue-500 text-5xl mb-4">
                    <i class="fas fa-book-open"></i>
                </div>
                <h3 class="text-xl font-semibold text-gray-900 dark:text-gray-100">Kurikulum Berkualitas</h3>
                <p class="mt-2 text-gray-600 dark:text-gray-300">Dikembangkan oleh pakar pendidikan terbaik untuk mendukung pembelajaran yang efektif.</p>
            </div>
            ...
            <div class="p-8 bg-white dark:bg-gray-800 rounded-lg shadow-lg text-center transform hover:scale-105 transition duration-300">
                ...
                <p class="mt-2 text-gray-600 dark:text-gray-300">Dipandu oleh tenaga pengajar yang berpengalaman dan ahli di bidangnya.</p>
            </div>
            ...
            <div class="p-8 bg-white dark:bg-gray-800 rounded-lg shadow-lg text-center transform hover:scale-105 transition duration-300">
                ...
                <p class="mt-2 text-gray-600 dark:text-gray-300">Sertifikat yang diakui secara nasional dan internasional sebagai bukti kompetensi Anda.</p>
            </div>
        </div>
    </div>
</section>
...
<section id="contact" class="py-16 bg-white dark:bg-gray-900">
    <div class="container mx-auto px-6">
        <div class="text-center mb-12">
            ...
            <p class="mt-2 text-gray-600 dark:text-gray-300">Silakan hubungi kami atau kirimkan pesan langsung melalui formulir.</p>
        </div>

        <div class="flex flex-col md:flex-row items-stretch justify-center gap-12">
            <!-- Form Kontak (Kiri) -->
            <div class="w-full md:w-1/2 bg-gray-100 dark:bg-gray-800 p-8 rounded-lg shadow-lg flex flex-col justify-center h-full">
                ...
                <form action="#" method="POST" class="space-y-4 flex-1">
                    <div>
                        <label for="name" class="block text-gray-700 dark:text-gray-300 font-medium">Nama Lengkap</label>
                    ...
                    <div>
                        <label for="message" class="block text-gray-700 dark:text-gray-300 font-medium">Pesan</label>
            ...
            <div class="w-full md:w-1/2 bg-gray-100 dark:bg-gray-800 p-8 rounded-lg shadow-lg flex flex-col justify-center h-full">
                ...
                <p class="text-gray-600 dark:text-gray-300 mb-4">Jangan ragu untuk menghubungi kami, tim kami siap membantu Anda!</p>
    ...
    <div class="container mx-auto px-6">
        <div class="grid md:grid-cols-3 gap-8 text-center md:text-left">
            ...
            <div>
                ...
                <p class="mt-2 text-gray-400">Memberikan layanan pendidikan terbaik untuk masa depan yang lebih cerah.</p>
            </div>
